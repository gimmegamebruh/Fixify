...
class MainTabBarController: UITabBarController {
    ...
    override func viewDidLoad() {
        ...
        let home = UINavigationController(rootViewController: HomeTableViewController())
        ...
        notifications.tabBarItem = UITabBarItem(title: "Notifications",
                                                image: UIImage(systemName: "bell"),
                                                selectedImage: UIImage(systemName: "bell.fill"))

        let chat = UINavigationController(rootViewController: ChatListViewController())
        chat.tabBarItem = UITabBarItem(title: "Chat",
