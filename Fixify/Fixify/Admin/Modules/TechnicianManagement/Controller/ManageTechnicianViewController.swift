...
final class ManageTechnicianViewController: UIViewController {
    ...
    private let viewModel: ManageTechnicianViewModel
    private let tableView = UITableView()

    init(requestID: String) {
        self.viewModel = ManageTechnicianViewModel(requestID: requestID)
...
extension ManageTechnicianViewController: UITableViewDataSource {
